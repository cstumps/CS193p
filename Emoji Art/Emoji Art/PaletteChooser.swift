...
struct PaletteChooser: View {
    ...
    func view(for palette: Palette) -> some View {
        ...
        // Transistions only work on views that are coming and going.  the HStack is never actually leaving,
        // the values of what it's showing are just changing.  Adding the .id modifier uniquely identifies the
        // view and makes it be removed and added.
        .id(palette.id)
