...
struct Palette: Identifiable, Codable, Hashable {
    ...
    // This was originally a static let which won't work right with decoded data.  Changed to generate
    // these palettes every time builtins is accessed. See lecture 12 ~55:50.
