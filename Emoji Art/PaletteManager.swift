...
//  Emoji Art
//
//  Created by Jason Hirst on 7/10/24.
//
...
struct PaletteManager: View {
    ...
    // Could implement navigation links and destinations like he did in the PaletteList however
    // he wanted to show a different way to do it here by tracking the selection.
